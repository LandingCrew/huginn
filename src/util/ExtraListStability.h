...
namespace Huginn::Util
{
    ...
    /// (RefreshCharges both overloads, ReconcileWeapons, ScanWeaponFavorites) and
    /// ItemRegistry's soul-gem scan. Callers skip the extraList-derived portion of
    /// their scan when not yet stable and pick it up on their next periodic pass.
