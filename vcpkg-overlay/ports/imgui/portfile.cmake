...
# Huginn: Disable IM_ASSERT to prevent CTD in debug builds.
# Multiple SKSE plugins (Wheeler, Huginn) run independent ImGui contexts on the
# same D3D11 device.  Rare internal vector-index assertions fire without
# indicating a real bug — the default assert() shows a modal dialog and aborts.
vcpkg_replace_string("${SOURCE_PATH}/imconfig.h"
    "#pragma once"
    "#pragma once\n#ifndef _WINDOWS_\n#include <windows.h>\n#endif"
)
vcpkg_replace_string("${SOURCE_PATH}/imconfig.h"
    "//#define IM_ASSERT(_EXPR)  ((void)(_EXPR))     // Disable asserts"
    "#define IM_ASSERT(_EXPR)  do { if (!(_EXPR)) { OutputDebugStringA(\"[Huginn] ImGui assert failed: \" #_EXPR \"\\n\"); } } while (0)     // Huginn: log to debugger instead of CTD"
)
