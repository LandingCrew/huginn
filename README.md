...
Huginn is an Skyrim SE SKSE plugin that watches what you can see — health, enemies, environment — and surfaces the right spell, potion, weapon, or item before you need to dig through menus. It learns your preferences over time through lightweight reinforcement learning. It never acts on its own.

https://youtu.be/VtSp32RGPZM
...
- **Scaleform HUD widget** — minimal overlay with keybinds for hotkey injection
...
- **Spell Mod Compatibility** — has a spell classification system to sort into recommendation catagories. Overrides loaded at init 
- **Console Commands** — troubleshooting, system resets, restart and repair
- **dMenu configurations (Optional)** — enable/disable HUD widget
- **Wheeler integration (Optional)** —  [Wheeler](https://github.com/LandingCrew/wheelerAPI) radial menu support
